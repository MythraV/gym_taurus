...
def main():
    ...
    parser.add_argument('--new-name', default="ppo2_taurus", type=str, help='name of model to train')
    ...
    def make_env(rank, seed=0):
        ...
        """
        def _init():
            env = envs.TaurusEnv('left','debri_res_1',mode='passive', headless=False,maxval=0.1)
            env.seed(seed + rank)
            return env
